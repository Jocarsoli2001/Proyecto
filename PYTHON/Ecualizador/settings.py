"""
Django settings for Ecualizador project.
...
SECRET_KEY = 'django-insecure-!md6c5b&rh03i+d(j5ldpe-5ztt)=ycy5k*fz*o$i##4qtu(ql'
...
INSTALLED_APPS = [
    ...
    'app_ecualizador.apps.AppEcualizadorConfig',
]
...
WSGI_APPLICATION = 'Ecualizador.wsgi.application'
